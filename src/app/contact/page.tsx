  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col pt-20 bg-background overflow-hidden selection:bg-primary/20">
        ...
        {/* Hero Section */}
        <section className="relative pt-16 pb-0 md:pt-20 md:pb-0 overflow-hidden flex items-center justify-center bg-gradient-to-br from-primary/10 via-background to-secondary/10">
          {/* Ambient Glows */}
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <motion.div
                ...
                className="-mt-8 md:-mt-16 lg:-mt-24 pl-4 md:pl-8 lg:pl-12"
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary font-medium text-[11px] mb-3 border border-primary/20 shadow-sm">
                  <Headset className="w-3.5 h-3.5" />
                  Support
                </div>
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading font-extrabold tracking-tight text-foreground drop-shadow-sm leading-tight">
                  Contact <span className="text-purple-500">Us</span>
                </h1>
                <p className="mt-4 text-base md:text-lg lg:text-xl text-muted-foreground font-medium max-w-xl leading-relaxed">
                ...
                <div className="flex flex-wrap items-center gap-4 mt-8">
                  <button 
                    ...
                    className="inline-flex items-center justify-center gap-2 px-8 py-4 text-sm md:text-base font-bold text-primary-foreground bg-primary rounded-full hover:bg-primary/90 transition-all shadow-lg hover:shadow-primary/25 hover:-translate-y-1"
                  >
                  ...
                  <button 
                    ...
                    className="inline-flex items-center justify-center gap-2 px-8 py-4 text-sm md:text-base font-bold text-foreground bg-card border-2 border-border/50 rounded-full hover:border-primary/50 hover:bg-muted/50 transition-all shadow-sm hover:-translate-y-1"
                  >
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8 }}
                className="flex justify-center lg:justify-end -ml-4 lg:-ml-12"
              >
                <img
                  src="/Assets/animations/contact us.svg"
                  alt="Contact Illustration"
                  className="w-full max-w-lg h-auto object-contain drop-shadow-2xl scale-110 origin-right"
                />
              </motion.div>
            </div>
          </div>
        ...
        <section id="office-location" className="py-24 bg-background border-t border-border/50">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="w-full h-[300px] mt-6 lg:mt-8 rounded-3xl overflow-hidden border border-border shadow-lg relative group">
