    ...
    <>
      ...
      <main className="flex-1 flex flex-col pt-20 bg-background overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              ...
              >
                ...
                <h1 className="text-4xl md:text-5xl lg:text-7xl font-heading font-extrabold tracking-tight mb-6 text-foreground">
        ...
        <section className="py-24 container mx-auto px-4 md:px-6">
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground">Featured Articles</h2>
            <p className="text-muted-foreground mt-2 text-lg">Curated highlights from the forefront of AI.</p>
          </div>
